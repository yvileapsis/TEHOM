...
module SlugDemoHudComputeSupport =
    let private roundedCommands = SlugShowcaseContours.roundedRectCommands 0.08f
    let private smallRoundedCommands = SlugShowcaseContours.roundedRectCommands 0.14f
    let private circleCommands = SlugShowcaseContours.circleCommands
    ...
    let placeContour name tessellation position size rotation elevation world =
        SlugShowcaseContours.placeContour name tessellation position size rotation elevation world
