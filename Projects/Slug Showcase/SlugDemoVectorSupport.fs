...
module SlugDemoVectorSupport =
    ...
    let private contour commands fillColor winding strokeColor strokeThickness scale =
        SlugShowcaseContours.makeFilled commands fillColor winding strokeColor strokeThickness scale
    ...
    let linearGradientShape =
        makeGradientShape
            (SlugShowcaseContours.roundedRectCommands 0.08f)
    ...
    let shapeRoundedRect =
        contour
            (SlugShowcaseContours.roundedRectCommands 0.13f)
    ...
    let compositeBody =
        contour
            (SlugShowcaseContours.roundedRectCommands 0.14f)
