...
module TehomExtensions =
    type Game with
        member this.GetMyGame world = this.GetModelGeneric<Tehom> world
        member this.SetMyGame value world = this.SetModelGeneric<Tehom> value world
        member this.MyGame = this.ModelGeneric<Tehom> ()
