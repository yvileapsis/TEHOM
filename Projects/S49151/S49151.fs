...
[<AutoOpen>]
module S49151Extensions =
    type Game with
        member this.GetS49151 world = this.GetModelGeneric<S49151> world
        member this.SetS49151 value world = this.SetModelGeneric<S49151> value world
        member this.S49151 = this.ModelGeneric<S49151> ()
...
type S49151Dispatcher () =
    inherit GameDispatcher<S49151, S49151Message, S49151Command> (Splash)
    ...
    override this.Definitions (model, _) = [
        ...
        if model = Splash then Simulants.Splash.DeselectingEvent => ShowTitle
