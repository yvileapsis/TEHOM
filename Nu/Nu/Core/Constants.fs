...
module Render =
    ...
    let [<Literal>] VoxelModelMessagesPrealloc = 256
...
module Paths =
    ...
    let [<Literal>] PhysicallyBasedDeferredVoxelShaderFilePath = "Assets/Default/PhysicallyBasedDeferredVoxel.glsl"
    ...
    let [<Literal>] PortalCompositeShaderFilePath = "Assets/Default/PortalComposite.glsl"
