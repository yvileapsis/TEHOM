            ...
            if not combo then
                if  ty.IsGenericType &&
                    ...
                    (ty.GenericTypeArguments[0].IsValueType ||
                     ...
                     ty.GenericTypeArguments[0] = typeof<VoxelModel AssetTag> ||
                    ...
                    let (edited2, value) =
                        if ImGui.Checkbox ("##" + name, &isSome) then
                            if isSome then
                                ...
                                elif ty.GenericTypeArguments[0] = typeof<VoxelModel AssetTag> then (true, Activator.CreateInstance (ty, [|Assets.Default.VoxelModel :> obj|]))
                    ...
                    let (edited2, value) =
                        if ImGui.Checkbox ("##" + name, &isSome) then
                            ...
                            if isSome then
                                ...
                                elif ty.GenericTypeArguments[0] = typeof<VoxelModel AssetTag> then (true, createValueOption Assets.Default.VoxelModel)
