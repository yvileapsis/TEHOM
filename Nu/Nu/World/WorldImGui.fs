            ...
            if not combo then
                if  ty.IsGenericType &&
                    ...
                    (ty.GenericTypeArguments[0].IsValueType ||
                     ...
                     ty.GenericTypeArguments[0] = typeof<MsdfFont AssetTag> ||
                     ty.GenericTypeArguments[0] = typeof<SlugFont AssetTag> ||
                    ...
                    let (edited2, value) =
                        if ImGui.Checkbox ("##" + name, &isSome) then
                            if isSome then
                                ...
                                elif ty.GenericTypeArguments[0] = typeof<MsdfFont AssetTag> then (true, Activator.CreateInstance (ty, [|Assets.Default.FontMtsdf :> obj|]))
                                elif ty.GenericTypeArguments[0] = typeof<SlugFont AssetTag> then (true, Activator.CreateInstance (ty, [|Assets.Default.FontSlug :> obj|]))
                    ...
                    let (edited2, value) =
                        if ImGui.Checkbox ("##" + name, &isSome) then
                            ...
                            if isSome then
                                ...
                                elif ty.GenericTypeArguments[0] = typeof<MsdfFont AssetTag> then (true, createValueOption Assets.Default.FontMtsdf)
                                elif ty.GenericTypeArguments[0] = typeof<SlugFont AssetTag> then (true, createValueOption Assets.Default.FontSlug)
